% =========================================================================
% dmp_baseline_nom_rigid.mod  --  PRIMARY BASELINE MODEL
%
% Boeck, Crespo Cuaresma, and Glocker (2026):
% "Labor Market Institutions, Fiscal Multipliers, and
%  Macroeconomic Volatility"
%
% New Keynesian model with Diamond-Mortensen-Pissarides (DMP) labor market
% frictions, calibrated at monthly frequency. This is the main model used
% to generate the theoretical results in Section 3 and Appendix B.
%
% Key features:
%   - Endogenous job separation (Krause and Lubik, 2007): idiosyncratic
%     productivity a ~ LogNormal(mua, siga); separation if a < atilde
%   - Nash wage bargaining with optional real wage rigidity (rhorw)
%   - Calvo price stickiness (thetaP) with optional indexation (gammaP)
%   - Taylor rule with interest rate smoothing (rho_i)
%   - Optional non-Ricardian (hand-to-mouth) households (xi > 0)
%   - Optional firing costs as government revenue (FCBC = 1)
%   - Optional public capital in production function (alphaG > 0)
%
% Shocks: government spending (shockG), TFP (shockA), monetary policy
%   (shockMP) -- activated via the shock selector vector in the console.
%
% Called from: Modellsimulationshauptdatei.m
% Steady-state solver: console_baseline.m
% External functions: Atfct.m, Ftfct.m
% Produces: Figure_2.pdf, Figure_B1.pdf through Figure_B6.pdf
% =========================================================================
