% =========================================================================
% dmp_baseline_nom_rigid_nrh.mod  --  NON-RICARDIAN HOUSEHOLDS
%
% Boeck, Crespo Cuaresma, and Glocker (2026):
% "Labor Market Institutions, Fiscal Multipliers, and
%  Macroeconomic Volatility"
%
% NK-DMP model with non-Ricardian (hand-to-mouth) households (xi > 0).
% Nominal price rigidities (Calvo). Flexible Nash wages (no real wage
% rigidity). Simplified Taylor rule. Used for robustness analysis of
% the non-Ricardian household extension (Appendix B, Figure B3).
%
