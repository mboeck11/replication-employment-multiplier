% =========================================================================
% dmp_baseline_nrh.mod  --  NOMINAL RIGIDITIES + NON-RICARDIANS + RWR
%
% Boeck, Crespo Cuaresma, and Glocker (2026):
% "Labor Market Institutions, Fiscal Multipliers, and
%  Macroeconomic Volatility"
%
% NK-DMP model combining: (i) nominal price rigidities (Calvo), (ii)
% non-Ricardian (hand-to-mouth) households (xi > 0), and (iii) optional
% real wage rigidity (rhorw). Simplified Taylor rule. Used for robustness
% analyses combining multiple frictions.
%
