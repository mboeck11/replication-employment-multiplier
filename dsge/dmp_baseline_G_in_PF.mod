% =========================================================================
% dmp_baseline_G_in_PF.mod  --  GOVERNMENT SPENDING IN PRODUCTION
%
% Boeck, Crespo Cuaresma, and Glocker (2026):
% "Labor Market Institutions, Fiscal Multipliers, and
%  Macroeconomic Volatility"
%
% DMP baseline model extended to allow government spending to enter the
% production function as productive public capital (alphaG > 0). Capital
% evolves as kg_t = (1-delta)*kg_{t-1} + g_t. Corresponds to the
% alphaG > 0 case in dmp_baseline_nom_rigid.mod. Used for Appendix B
% robustness (Figure B5).
%
...
gss thetass pss Tsss Ftss atss Atss rhotss kgss % steady state values
